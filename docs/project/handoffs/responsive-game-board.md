...
last-updated: 2026-04-27 (OPT-308 + OPT-309 + OPT-313 + OPT-316 + OPT-317 merged; OPT-319 in review; OPT-310 / OPT-314 / OPT-315 ready now)
---
...
| 4 | [OPT-319](https://linear.app/optcg-sim/issue/OPT-319) | Verify card image source resolution ≥ 2x design size | 2 | — | In Review | _(this PR)_ | Confirmed 600×838 PNG source ≈ 5× design size — 2.5× headroom over the 2× crispness floor. No re-ingest needed. Headroom math + sample list in `docs/architecture/DATA-PIPELINE.md` §"Resolution Headroom (OPT-319 verification, 2026-04-27)". |
...
**Next up:** OPT-310 — `useBoardScale()` hook (deps satisfied, ready now). OPT-314 / OPT-315 (the two shells consuming the primitives) are also ready now and can run in parallel — both depend on OPT-308/OPT-309/OPT-313, all merged. OPT-311 unblocks once OPT-310 lands; OPT-312's Storybook entries unblock once OPT-310/311 land.
...
### OPT-319 → OPT-310
**From:** session on 2026-04-27 · **Commit:** `7ec62bc` · **PR:** _(opened from this branch)_
