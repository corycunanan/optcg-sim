...
| 34 | OPT-473 | Execute and gate every authored action handler, including the six zero-covered handlers | — | OPT-471 | In Review | [#291](https://github.com/corycunanan/optcg-sim/pull/291) | 3,548-use inventory; 72/72 handled and executed; global and hotspot coverage ratchets. |
