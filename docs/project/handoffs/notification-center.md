...
| 2     | OPT-525 | Notification model + API (list, mark-read, action proxy)                                 | —        | —                         | In Progress | [#445](https://github.com/corycunanan/optcg-sim/pull/445) | Durable data/API foundation                            |
