...
| 4     | OPT-522 | Join-by-code party switching with disband confirmation                                   | —        | OPT-519                            | In Review   | [#403](https://github.com/corycunanan/optcg-sim/pull/403) | Transactional switch and host-disband semantics           |
...
- **Gotchas / do NOT touch:** Preserve the exact disband language and the `confirmSwitch` retry contract. OPT-523 owns the guest-seat kick menu/endpoint, and OPT-524 owns invite countdown/cancel UI; integrate their shipped surfaces instead of recreating them.
