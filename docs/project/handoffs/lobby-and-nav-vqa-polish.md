...
| 6 | OPT-608 | Normalize /decks page width to max-w-7xl to match the navbar and other routes | — | OPT-607 | In Review | [#483](https://github.com/corycunanan/optcg-sim/pull/483) | Shared header, deck, card-browser, and loading surfaces now use the app-wide container. |
...
| 9 | OPT-586 | Friends panel: presence dots, section naming, request actions | — | OPT-529 | Done | [#481](https://github.com/corycunanan/optcg-sim/pull/481) | Re-scoped after PR #453; retained notification-center ownership. |
| 10 | OPT-585 | Footer bar: disabled Start Match affordance, Match settings, spectator defaults | — | OPT-595 | Done | [#482](https://github.com/corycunanan/optcg-sim/pull/482) | Spectator pill + neutral disabled Start Match in the footer. |
