...
| 6 | OPT-608 | Normalize /decks page width to max-w-7xl to match the navbar and other routes | — | OPT-607 | Done | [#483](https://github.com/corycunanan/optcg-sim/pull/483) | Shared header, deck, card-browser, and loading surfaces now use the app-wide container. |
