...
| `effect`                  |                             97 records | Vegapull collapses official `<br>` boundaries to spaces. Every effect is text-identical after normalizing `<br>` and whitespace.                                | Accepted official formatting. OP17-105's complete effect remains intact.                                     |
