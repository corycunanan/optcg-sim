...
| 4 | [OPT-354](https://linear.app/optcg-sim/issue/OPT-354) | Chat push (P1) — delete 5s chat poll | 3 | OPT-353 ✓ | In Review | _PR pending_ | First polling loop deleted; +60s backstop. Establishes the per-poll-replacement pattern for T5–T7. |
...
### OPT-354 → OPT-355
**From:** session on 2026-05-02 · **Commit:** `047e9c9` · **PR:** _opening now — chat push (P1)_
