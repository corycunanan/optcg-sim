...
last-updated: 2026-05-02 · OPT-354 in review; OPT-353 (#208) merged
---
...
| 4 | [OPT-354](https://linear.app/optcg-sim/issue/OPT-354) | Chat push (P1) — delete 5s chat poll | 3 | OPT-353 ✓ | In Review | [#209](https://github.com/corycunanan/optcg-sim/pull/209) | First polling loop deleted; +60s backstop. Establishes the per-poll-replacement pattern for T5–T7. |
...
**Next up:** OPT-355 (friends push, P2 — delete 30s sidebar poll). Ready now — depends only on OPT-353 ✓. OPT-356, OPT-357, OPT-358 are also unblocked and can run in parallel with OPT-355 / each other.
