...
|-------|--------|-------|----------|------------|--------|----|-------|
| 1 | [OPT-351](https://linear.app/optcg-sim/issue/OPT-351) | Extract `useAuthedWebSocket` shared hook | 3 | — | Backlog | — | Pure refactor; unblocks every other ticket |
...
**Next up:** OPT-351 (or OPT-352 — either can lead; OPT-351 is the lower-risk start).
