...
| ----- | ---------------------------------------------------------------------------------------------------------------------------- | --------------------------------------------- | -------- | ----------- | ------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| 1     | [OPT-385](https://linear.app/optcg-sim/issue/OPT-385/confirm-in-game-concede-a-misclick-currently-loses-the-match-instantly) | Confirm in-game Concede                       | High     | In Progress | `src/components/game/board-layout/nav-menu.tsx`                                      | Worst single misclick: immediate match loss.                                    |
