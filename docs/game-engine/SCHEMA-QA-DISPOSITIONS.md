...
| OP16-036 | Implemented / false positive | `COPY_POWER` uses the opponent Leader's effective base power, excluding additive power and DON!! (`source_power: "BASE"`; OPT-833), matching the card's explicit “base power” wording.                                                                                              |
