...
export function CardBack({
  ...
  return (
    ...
    >
      ...
      />
      {label && (
        <span className="pointer-events-none absolute inset-0 flex items-center justify-center text-base text-gb-text-dim/40 select-none uppercase tracking-wider">
          {label}
        </span>
      )}
    </div>
