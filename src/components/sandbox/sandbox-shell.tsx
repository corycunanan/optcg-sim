    ...
    <MinViewportGate>
      <div className="flex h-full flex-col overflow-hidden bg-gb-board">
        ...
        <header className="flex shrink-0 items-center gap-3 border-b border-border bg-card px-5 py-2">
          <Link
            href="/sandbox"
            className="inline-flex items-center gap-2 rounded-md px-2 py-1 text-sm font-medium text-content-secondary hover:bg-secondary hover:text-content-primary"
          >
