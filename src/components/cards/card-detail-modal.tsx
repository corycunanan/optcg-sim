...
function Row({ label, children, className }: { label?: string; children: React.ReactNode; className?: string }) {
  return (
    <div className={cn("py-4", className)}>
      {label && (
        <div className="mb-2 text-sm font-semibold uppercase tracking-widest text-content-tertiary">
          {label}
        </div>
      )}
      {children}
...
function Stat({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex flex-col gap-1">
      <span className="text-sm font-semibold uppercase tracking-widest text-content-tertiary">{label}</span>
              ...
              <div className="divide-y divide-border">
                ...
                <Row>
                  <div className="grid grid-cols-2 gap-6">
                    <div>
                      <div className="mb-2 text-sm font-semibold uppercase tracking-widest text-content-tertiary">Traits</div>
                    ...
                    <div>
                      <div className="mb-2 text-sm font-semibold uppercase tracking-widest text-content-tertiary">Attributes</div>
                    ...
                    <div className="flex flex-col gap-2">
                      {card.cardSets.map((cs) => (
                        <div key={cs.id} className="flex items-center gap-2 text-sm">
                          <span className="font-mono font-semibold text-content-primary">{cs.setLabel}</span>
