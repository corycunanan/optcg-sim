            ...
            <div className="flex items-center justify-between px-5 pt-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="border-border text-content-secondary hover:bg-secondary hover:text-content-primary rounded-md border px-3 py-1 text-sm font-medium transition-colors"
                >
                  Import
                </button>
                <button
