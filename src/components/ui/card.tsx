...
function Card({
  ...
  return (
    <ChamferFrame
      ...
      surfaceClassName={cn(
        "flex h-full flex-col gap-4 overflow-hidden bg-card py-4 text-sm text-card-foreground has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 group-data-[size=sm]/card:gap-3 group-data-[size=sm]/card:py-3 group-data-[size=sm]/card:has-data-[slot=card-footer]:pb-0",
        surfaceClassName
      )}
      {...props}
    />
