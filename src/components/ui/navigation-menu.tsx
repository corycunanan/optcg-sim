...
function NavigationMenuViewport({
  ...
  return (
    <NavigationMenuPrimitive.Indicator
      aria-hidden={false}
      className={cn("absolute top-full left-0 isolate z-50 flex justify-start")}
    >
      <NavigationMenuPrimitive.Viewport
        data-slot="navigation-menu-viewport"
        className={cn(
          "origin-top-center bg-popover text-popover-foreground ring-foreground/10 data-open:animate-in data-open:zoom-in-90 data-closed:animate-out data-closed:zoom-out-90 relative mt-1.5 h-(--radix-navigation-menu-viewport-height) w-(--radix-navigation-menu-viewport-width) shrink-0 overflow-hidden rounded-lg shadow ring-1 duration-100",
          className
        )}
        {...props}
      />
