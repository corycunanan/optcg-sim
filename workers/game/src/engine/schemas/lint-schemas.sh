...
const HANDLED_ACTION_TYPES = new Set([
  // Draw / search
  "DRAW", "SEARCH_DECK", "SEARCH_TRASH_THE_REST", "MILL", "FULL_DECK_SEARCH", "DECK_SCRY",
  // Modifiers
  ...
  // Life
  "ADD_TO_LIFE", "ADD_TO_LIFE_FROM_DECK", "TRASH_FROM_LIFE", "TURN_LIFE_FACE_UP", "TURN_LIFE_FACE_DOWN",
