...
export const CARDS = {
  ...
  RUSH: makeCard("CHAR-RUSH", { cost: 2, power: 3000, effectText: "[Rush]", keywords: { ...noKeywords(), rush: true } }),
  RUSH_CHAR: makeCard("CHAR-RUSH-C", { cost: 2, power: 3000, effectText: "[Rush: Character]", keywords: { ...noKeywords(), rushCharacter: true } }),
